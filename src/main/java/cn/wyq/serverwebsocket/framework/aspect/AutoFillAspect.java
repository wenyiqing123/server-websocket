package cn.wyq.serverwebsocket.framework.aspect;

import cn.wyq.serverwebsocket.framework.annotation.AutoFill;
import cn.wyq.serverwebsocket.framework.constant.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     */
    @Pointcut("execution(* cn.wyq.serverwebsocket.mapper.*.*(..)) && @annotation(cn.wyq.serverwebsocket.framework.annotation.AutoFill)")
